...
export default function Gallery() {
  ...
  const images = [
    ...
    {
      id: 15,
      url: '/assets/gallery15.jpg',
      alt: 'Jawai Bandh' 
    },
    {
      id: 16,
      url: '/assets/gallery16.jpg',
      alt: 'Jawai Bandh' 
    },
    {
      id: 17,
      url: '/assets/gallery17.jpg',
      alt: 'Jawai Bandh' 
    },
    {
      id: 18,
      url: '/assets/gallery18.jpg',
      alt: 'Jawai Bandh' 
    },
    {
       id: 19,
      url: '/assets/gallery19.jpg',
      alt: 'Jawai Bandh'
    },
    {
      id: 20,
      url: '/assets/gallery20.jpg',
      alt: 'Jawai Bandh'
    },
    {
       id: 21,
      url: '/assets/gallery21.jpg',
      alt: 'Jawai Bandh'
    }
...
{/* heading */}
<h2 className="text-3xl font-bold text-gray-800 my-16 text-center">Image Gallery</h2>
        {/* Gallery Grid */}
